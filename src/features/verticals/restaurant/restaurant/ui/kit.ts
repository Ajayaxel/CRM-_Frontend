/**
 * The POS console uses the platform design-system kit rather than a second copy
 * of it — same reasoning as hospitality and coworking, and the same single
 * import path to change the day the kit moves out of features/insurance.
 */
export {
